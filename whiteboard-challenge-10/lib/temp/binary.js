...
function binarySearch(arr, num, l, r) {
  if (arr instanceof Array) {
    ...
    if (num < arr[mid]) {
      ...
      return binarySearch(arr, num, l, r - mid); //return array length - right half
    }

    console.log("take right"); //or take right, display path
    return binarySearch(arr, num, mid, r); //return right half of array
